                ...
                do {
                    ...
                    if (ch == 2) { //Receive
                        ...
                        if (flagR == 1) {
                            ...
                            /*Added from internal event - START*/
                            ...
                            for (ClientHandler c : clients) {
                                ...
                                offset = avg - preClock;
                                System.out.println("Server send to " + c.getName() + ": " + avg + " - " + preClock + "="
                                        + offset + "\n");
                                ...
                                //System.out.println("Clock for "+ c.getName() + " value : " + this.data.get(c.getName()).getClock());
                            }
                            /*Added from internal event - END*/
                            flagS = 1;
                            flagR = 0;
                        }
                    }
